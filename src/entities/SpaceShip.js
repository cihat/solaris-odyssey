...
export default class SpaceShip {
  ...
  createBullet() {
    const bulletX = this.ship.x + (this.ship.width - this.bullet.width) / 2
    const bulletY = this.ship.y - this.bullet.height
    return new Bullet(bulletX, bulletY, this.bullet.width, this.bullet.height)
  }
